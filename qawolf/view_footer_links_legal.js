...
(async () => {
  ...
  await expect(
    page.locator("text=At Replay, we take your privacy seriously.")
  ).toBeVisible();
  ...
  await expect(
    page.locator(
      "text=Please read on to learn the rules and restrictions that govern your use of our website(s)"
    )
  ).toBeVisible();
