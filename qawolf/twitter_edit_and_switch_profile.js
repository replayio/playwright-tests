...
(async () => {
  shared.TEST_NAME = "Twitter: Edit and Switch Profile";
  ...
  await expect(page.locator(`:text("Updated ${bio}") >> nth = 0`)).toBeVisible();
  await expect(page.locator(`:text("New ${address}") >> nth = 0`)).toBeVisible();
