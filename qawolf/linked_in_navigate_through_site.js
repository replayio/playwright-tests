...
(async () => {
  shared.TEST_NAME = "LinkedIn: Navigate through site";
  ...
  await expect(page.locator(':text("Start a post")')).toBeVisible();
  await expect(page.locator(".feed-shared-social-actions").first()).toContainText(
    "Like"
  );
  await expect(page.locator(".feed-shared-social-actions").first()).toContainText(
    "Comment"
  ...
  await expect(
    page.locator(
      "text=Discover fresh ideas and jobs on LinkedIn through your connections and their networks. Find your first connection below."
    )
  ).toBeVisible();
  await page.click('[data-test-app-aware-link=""]:has-text("My Network")');
  await expect(page.locator("text=Manage my network")).toBeVisible();
  ...
  await expect(
    page.locator("text=Connect with people you know, fast")
  ).toBeVisible();
  await page.click('[data-test-app-aware-link=""]:has-text("My Network")');
  await expect(page.locator("text=Manage my network")).toBeVisible();
  await page.waitForTimeout(5000);
  ...
  await expect(
    page.locator(
      "text=Follow creators based on your interest to see their latest news and updates."
    )
  ).toBeVisible();
  await page.click('[data-test-app-aware-link=""]:has-text("My Network")');
  await expect(page.locator("text=Manage my network")).toBeVisible();
  ...
  await expect(
    page.locator(
      "text=A Newsletter highlighting trending topics, conversations and tools to help navigate the changing world of work."
    )
  ).toBeVisible();
  await page.click('[data-test-app-aware-link=""]:has-text("My Network")');
  await expect(page.locator("text=Manage my network")).toBeVisible();
  ...
  await expect(
    page.locator(':text("Recommended for you"):visible')
  ).toBeVisible();
  await page.waitForTimeout(5000);
  ...
  await expect(
    page.locator(
      "text=Flip the switch on a job search page to create a new alert."
    )
  ).toBeVisible();
  ...
  await page.click(
    '[data-test-app-aware-link=""]:has-text("Demonstrate skills")'
  );
  await expect(
    page.locator(
      "text=Considering a new career? Pick a role, then show your transferable skills through written or video responses for recruiters to consider."
    )
  ).toBeVisible();
  ...
  await expect(
    page.locator("text=Tell me about yourself.").first()
  ).toBeVisible();
  await expect(
    page.locator("text=What is your greatest strength?")
  ).toBeVisible();
  await expect(
    page.locator("text=What is your greatest weakness?")
  ).toBeVisible();
  await page.click('[data-test-app-aware-link=""]:has-text("Jobs")');
  await expect(
    page.locator(':text("Recommended for you"):visible')
  ...
  await expect(
    page.locator("text=Get insights for formatting issues, keywords, and more.")
  ).toBeVisible();
  await expect(
    page.locator("text=Resumes you build on LinkedIn will appear here.")
  ).toBeVisible();
  await page.click('[data-test-modal-close-btn=""]');
  await expect(
    page.locator(':text("Recommended for you"):visible')
  ...
  await page.click(
    '[data-test-app-aware-link=""]:has-text("Job seeker guidance")'
  );
  await expect(page.locator("#tab_0")).toHaveText("I want to improve my resume");
  await expect(page.locator("#tab_1")).toHaveText(
    "I want to improve my LinkedIn Profile page"
  );
