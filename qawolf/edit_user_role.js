...
(async () => {
  ...
  await assertText(page, "User (pending)", {
    selector:
      "text=mail_outlinereplay+userrole@qawolf.emailUser (pending)expand_more",
  });
  ...
  await assertText(page, "Developer (pending)", {
    selector:
      "text=mail_outlinereplay+userrole@qawolf.emailDeveloper (pending)expand_more",
  });
