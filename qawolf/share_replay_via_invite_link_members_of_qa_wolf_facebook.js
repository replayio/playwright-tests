...
(async () => {
  ...
  expect(copiedLink).toEqual(buildUrl('/recording/facebook-no-search-results-for-new-chat--b30b1ebd-de5f-4fdd-9d49-5d55cb173f83'));
  ...
  await expect(page2.locator(`text=Sorry, you don't have permission!`)).toBeVisible();
