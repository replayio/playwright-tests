...
(async () => {
  ...
  await expect(page.locator('h1:has-text("QA Wolf Test User")')).toBeVisible();
  // - Address
  await expect(page.locator('text=Jacksonville Beach, Florida, United States ')).toBeVisible();
  // - Title
  // - Company 
  await expect(page.locator('div:has-text("Software Engineer at Fake, inc"):below(h1:has-text("QA Wolf Test User")) >> nth=0')).toBeVisible();
  // - Experience
  ...
  await expect(page.locator('[data-test-location-form-component=""] [data-test-text-entity-list-form-select=""]')).toHaveValue("Houston, Texas");
  
  // Assert Edit modal displays correctly 
  await expect(page.locator('[data-test-modal-container=""] #profile-edit-form-page-header')).toHaveText("Edit intro");
  ...
  await expect(page.locator('h1:has-text("New QA Wolf Test User")')).toBeVisible();
  await expect(page.locator('text=Houston, Texas, United States ')).toBeVisible();
  await expect(page.locator('div:has-text("Professional FOodie at Instagram, inc"):below(h1:has-text("QA Wolf Test User")) >> nth=0')).toBeVisible();
  ...
  await page.click('[data-test-navigation-button__link=""]:has-text("Edit contact info")');
  
  // Fill Phone number with new value
  const phone = faker.phone.phoneNumber("### ### ####");
  await page.fill('[data-test-single-line-text-form-component=""] #single-line-text-form-component-urn-li-fsu-profileContactInfoEditFormElement-PHONE-NUMBER-1', phone);
  
  // Select different phone type
  if (await page.inputValue('[data-test-form-element-group-elements=""] [data-test-text-entity-list-form-select=""]') === "Home") {
    await page.selectOption('select#text-entity-list-form-component-urn-li-fsu-profileContactInfoEditFormElement-PHONE-TYPE-1', 'Work');
  } else if (await page.inputValue('[data-test-form-element-group-elements=""] [data-test-text-entity-list-form-select=""]') === "Work") {
    await page.selectOption('select#text-entity-list-form-component-urn-li-fsu-profileContactInfoEditFormElement-PHONE-TYPE-1', 'Mobile');
  } else if (await page.inputValue('[data-test-form-element-group-elements=""] [data-test-text-entity-list-form-select=""]') === "Mobile") {
    await page.selectOption('select#text-entity-list-form-component-urn-li-fsu-profileContactInfoEditFormElement-PHONE-TYPE-1', 'Home');
  } else {
    await page.selectOption('select#text-entity-list-form-component-urn-li-fsu-profileContactInfoEditFormElement-PHONE-TYPE-1', 'Home');
  }
  ...
  await page.fill('[data-test-multiline-text-form-component=""] #multiline-text-form-component-urn-li-fsu-profileContactInfoEditFormElement-ADDRESS-1', address);
  
  // Select different Birthday
  // month
  if (await page.inputValue('[data-test-month-select=""]') === "1") {
    await page.selectOption('select#-urn-li-fsu-profileContactInfoEditFormElement-BIRTH-DATE-1-date-dropdown', '2');
  } else if (await page.inputValue('[data-test-month-select=""]') === "2") {
    await page.selectOption('select#-urn-li-fsu-profileContactInfoEditFormElement-BIRTH-DATE-1-date-dropdown', '3');
  } else if (await page.inputValue('[data-test-month-select=""]') === "3") {
    await page.selectOption('select#-urn-li-fsu-profileContactInfoEditFormElement-BIRTH-DATE-1-date-dropdown', '1');
  } else {
    await page.selectOption('select#-urn-li-fsu-profileContactInfoEditFormElement-BIRTH-DATE-1-date-dropdown', '1');
  }
  ...
  if (await page.inputValue('[data-test-day-select=""]') === "3") {
    await page.selectOption('select#-urn-li-fsu-profileContactInfoEditFormElement-BIRTH-DATE-1-date-dropdown-day-select', '4');
  } else if (await page.inputValue('[data-test-day-select=""]') === "4") {
    await page.selectOption('select#-urn-li-fsu-profileContactInfoEditFormElement-BIRTH-DATE-1-date-dropdown-day-select', '5');
  } else if (await page.inputValue('[data-test-day-select=""]') === "5") {
    await page.selectOption('select#-urn-li-fsu-profileContactInfoEditFormElement-BIRTH-DATE-1-date-dropdown-day-select', '3');
  } else {
    await page.selectOption('select#-urn-li-fsu-profileContactInfoEditFormElement-BIRTH-DATE-1-date-dropdown-day-select', '3');
  }
  ...
  await expect(page.locator('[data-test-artdeco-toast-item-type="success"]')).toBeVisible();
