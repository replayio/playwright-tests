...
(async () => {
  ...
  await page.goto(buildUrl('/recording/replay-to-do-list-replay-sample--fc8dade7-d55c-41aa-8f34-8476f809f5d4'));
  ...
  // go to second replay
  await page.goto(buildUrl('/recording/framer-replay-example--0ff790cd-81fc-441d-8a33-b570fc7850c4'));
