...
(async () => {
  const TEST_NAME = "Filter console by event type (search) on user role";
  ...
  await page.click('[data-test-id="ConsoleFilterToggles"] [data-test-id="EventTypes-event.pointer.pointerup"]');
