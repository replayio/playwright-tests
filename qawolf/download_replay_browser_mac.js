...
(async () => {
  ...
  // start download for Linux to switch to mac download
  await page.click('.os-linux [href="https://static.replay.io/downloads/linux-replay.tar.bz2"]');
  await page.waitForTimeout(5000);
  
  const [download] = await Promise.all([
    page.waitForEvent('download'),
    page.click('[href="https://static.replay.io/downloads/replay.dmg"]')
  ]);
