...
(async () => {
  shared.TEST_NAME = "User role: create, edit, reply and delete comments and replies";
  ...
  shared.page = page;
  shared.thirdCommentBlock = thirdCommentBlock;
  shared.progressLine = progressLine;
  shared.reply = reply;
