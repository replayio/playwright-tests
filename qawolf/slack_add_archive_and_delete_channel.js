...
(async () => {
  ...
  await page.click('[data-qa="channel_section_menu__create_channel-wrapper"] [data-qa="channel_section_menu__create_channel"]');
  ...
  await page.click('[data-qa="footer_actions_container"] [data-qa="invite_to_workspace_skip_button"]');
  
  // Assert:
  // Channel was created successully
  await expect(page.locator('text=You created this channel today. This is the very beginning of the testchannel channel.')).toBeVisible();
  ...
  await page.click('[data-qa="channel_details_modal"] [data-qa="channel_details_settings_tab"]');
  ...
  await expect(page.locator('[data-qa="channels"]')).not.toContainText("testchannel")
  ...
  await page.fill('[data-qa="browse_page_search_autocomplete_input"]', "testchannel");
  await page.waitForTimeout(3000);
  await page.keyboard.press('Enter');
  await page.click('[data-qa="browse_page_channel"] :text("testchannel (archived)")');
  ...
  await page.click('[data-qa="slack_kit_scrollbar"] [aria-label="Delete this channel"]');
