...
(async () => {
  ...
  // hide errors
  await page.uncheck(
    '[data-test-id="FilterToggle-errors"] #FilterToggle-errors'
  );
  await expect(
  ...
  // get message count
  const messagesCount1 = await page
    .locator('[data-test-name="Message"]')
    .count();
  ...
  // get message count
  const messagesCount2 = await page
    .locator('[data-test-name="Message"]')
    .count();
  ...
  // get message count
  const messagesCount3 = await page
    .locator('[data-test-name="Message"]')
    .count();
