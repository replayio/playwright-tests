...
(async () => {
  shared.TEST_NAME = "Wandb: Edit Profile and Intro";
  ...
  shared.page = page;
  shared.ogName = ogName;
  shared.ogBio = ogBio;
  shared.ogIntroText = ogIntroText;
  shared.newName = newName;
  shared.newBio = newBio;
  shared.fileChooser = fileChooser;
  shared.newIntroText = newIntroText;
  shared.newLinkTitle = newLinkTitle;
  shared.newLinkURL = newLinkURL;
  shared.fileChooser = fileChooser;
